<!-- Stored in resources/views/environment/explore.blade.php -->
		...
		@foreach ($markets as $market)
			<div class="market">
				...
				<div class="info">
					...
					<a class="subscribe" href="{{ url('/ctrl/m/subscription', [$market->name])}}">{{ (!empty($userSubscriptions[$market->id]) && $userSubscriptions[$market->id] != null) ? "Unsubscribe" : "Subscribe" }}</a>						<h2>{{ $market->description }}</h2>
					<div class="items">
